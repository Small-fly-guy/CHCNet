...
class BaseTransform(object):
    ...
    def __call__(self, image, img_box,density, boxes, points, size_orig):
        ...
        img_box= cv2.resize(img_box, (w_rsz, h_rsz))
        # gamma
        if self.gamma:
        ...
        if self.hflip:
            ...
            image, img_box,density, boxes_rsz, points_rsz = transform_fn(
                image,img_box, density, boxes_rsz, points_rsz
            )
        if self.vflip:
        ...
        return image,img_box, density, boxes_rsz, points_rsz
